...
if (ENVIRONMENT_IS_NODE) {
  var __dirname = path.join(process.argv[1], "../../basis")
}
        ...
        switch (this.sharingPolicy) {
          case 0:
            if (handle.$$.smartPtrType === this) {
              ...
              throwBindingError(
                `Cannot convert argument of type ${handle.$$.smartPtrType ? handle.$$.smartPtrType.name : handle.$$.ptrType.name} to parameter type ${
                  this.name
                }`
              )
            }
        ...
        var constructor = createNamedFunction(name, function (...args) {
          ...
          if (undefined === body) {
            throw new BindingError(
              `Tried to invoke ctor of ${name} with invalid number of parameters (${args.length}) - expected (${Object.keys(
