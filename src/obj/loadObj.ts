 ...
 * @private
 */
function loadObj(objPath: string, options: any) {
  ...
  const scratchVertexIndices: any[] = []
  const scratchPoints: any[] = []
...
function loadMtls(mtlPaths: string[], objPath, options) {
...
function assignDefaultMaterial(nodes, materials, usesMaterials?) {
