import { defined as _defined, RuntimeError as _RuntimeError } from "cesium"
import { getType } from "mime"
import { PNG } from "pngjs"
import Promise, { all, map } from "bluebird"
...
function writeEmbeddedTextures(gltf) {
  ...
  for (let i = 0; i < imagesLength; ++i) {
    ...
    image.mimeType = getType(texture.extension)
